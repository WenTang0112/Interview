...
namespace InterviewCRUD.Controllers
{
    ...
    {
        private readonly InterviewCRUDContext _context;

        public CarsController(InterviewCRUDContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Label,Type,cc,Color")] CarModel carModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Label,Type,cc,Color")] CarModel carModel)
        {
            if (id != carModel.Id)
            {
                return NotFound();
